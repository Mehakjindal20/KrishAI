...
data = pd.read_csv("Raw Data Soil Fettility.csv")

print(data.head(), "\n")
print(data.info(), "\n")

# Removed ydata_profiling because it is not supported on Streamlit Cloud Python 3.14
...
print("1 - Describes moderate fertility")
print("2 - Describes good fertility")
# import pandas as pd
